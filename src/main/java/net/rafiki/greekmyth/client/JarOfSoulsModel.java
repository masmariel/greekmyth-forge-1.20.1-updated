...
public class JarOfSoulsModel extends GeoModel<JarOfSoulsItem> {
    // Models must be stored in assets/<modid>/geo with subfolders supported inside the geo folder
    private static final ResourceLocation model = new ResourceLocation("greekmyth", "geo/jar_of_souls.geo.json");
    ...
    @Override
    public ResourceLocation getTextureResource(JarOfSoulsItem object) {
        return this.texture;
    }

    @Override
    public ResourceLocation getAnimationResource(JarOfSoulsItem object) {
