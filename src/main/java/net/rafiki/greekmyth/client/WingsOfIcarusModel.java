...
public class WingsOfIcarusModel extends GeoModel<WingsOfIcarusItem> {
    ...
    @Override
    public ResourceLocation getTextureResource(WingsOfIcarusItem object) {
        return this.texture;
    }

    @Override
    public ResourceLocation getAnimationResource(WingsOfIcarusItem object) {
