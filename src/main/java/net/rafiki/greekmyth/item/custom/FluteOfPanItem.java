...
import net.rafiki.greekmyth.client.FluteOfPanRenderer;
...
public class FluteOfPanItem extends Item implements GeoItem {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private FluteOfPanRenderer renderer = null;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null)
                    return new FluteOfPanRenderer();
