...
import net.rafiki.greekmyth.client.ClawOfTheNemeanLionRenderer;
...
public class ClawOfTheNemeanLionItem extends SwordItem implements GeoItem {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private ClawOfTheNemeanLionRenderer renderer = null;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null)
                    return new ClawOfTheNemeanLionRenderer();
