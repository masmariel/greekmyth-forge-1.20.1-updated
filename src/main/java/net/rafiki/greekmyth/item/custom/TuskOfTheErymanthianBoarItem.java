...
import net.rafiki.greekmyth.client.TuskOfTheErymanthainBoarRenderer;
...
public class TuskOfTheErymanthianBoarItem extends SwordItem implements GeoItem {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private TuskOfTheErymanthainBoarRenderer renderer = null;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null)
                    return new TuskOfTheErymanthainBoarRenderer();
