...
import net.rafiki.greekmyth.client.LabrysRenderer;
...
public class LabrysItem extends AxeItem implements GeoItem {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private LabrysRenderer renderer = null;

            @Override
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (renderer == null)
                    return new LabrysRenderer();
