...
import net.rafiki.greekmyth.entity.animations.CalydonianBoarAnimationDefinitions;
import net.rafiki.greekmyth.entity.custom.CalydonianBoarEntity;

public class CalydonianBoarModel<T extends CalydonianBoarEntity> extends HierarchicalModel<T> {
	private final ModelPart calydonian_boar;
	private final ModelPart head;

	public CalydonianBoarModel(ModelPart root) {
		this.calydonian_boar = root.getChild("rhino");
		this.head = calydonian_boar.getChild("body").getChild("torso").getChild("head");
	...
	@Override
	public void setupAnim(CalydonianBoarEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		calydonian_boar.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
	}

	@Override
	public ModelPart root() {
		return calydonian_boar;
	}
}